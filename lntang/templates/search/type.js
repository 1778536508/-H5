//自己找模板文件.tpl
define(["text!search/type.tpl"], function(testTpl) {
	//调用加载
	function type() {
		console.log("type加载");
		type_list();
...
//			ajaxData(val, offnum, limnum, num, cate, code);			
//		});
//		
//
//		//确定筛选
...
//			for(var j = 0; j<arr_Code.length; j++){};
//			var code = arr_Code[j-1];
//			ajaxData(val, offnum, lim, num, cate, code);
//		});
//		
//		
//	},10);	
//
//		function ajaxData(val, off, lim, num, cate, code) {
//			//参数	
//			//'keyword':  value="关键字"
//			//"offset":  （分页数-1）*一页的条数
//			//"limit": 	     一页的条数
